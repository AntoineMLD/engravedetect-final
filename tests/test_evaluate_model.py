...
class TestEvaluateModel:
    ...
    def test_compute_topk_accuracy_perfect_match(self):
        ...
        topk_acc, y_true, y_pred = compute_topk_accuracy(
            test_embeddings, test_labels, ref_embeddings, ref_labels, [1, 3]
        )
    ...
    def test_compute_topk_accuracy_no_match(self):
        ...
        topk_acc, y_true, y_pred = compute_topk_accuracy(
            test_embeddings, test_labels, ref_embeddings, ref_labels, [1]
        )
    ...
    def test_compute_topk_accuracy_partial_match(self):
        ...
        topk_acc, _, _ = compute_topk_accuracy(
            test_embeddings,
            test_labels,
            ref_embeddings,
            ref_labels,
    ...
    def test_topk_accuracy_with_different_k_values(self):
        ...
        topk_acc, _, _ = compute_topk_accuracy(
            test_embeddings, test_labels, ref_embeddings, ref_labels, [1, 3, 5]
        )
...
class TestPerformanceMetrics:
    ...
    def test_memory_usage_simulation(self):
        ...
        topk_acc, _, _ = compute_topk_accuracy(
            test_emb, test_lab, large_embeddings, large_labels, [1, 5]
        )
    ...
    def test_timing_consistency(self):
        ...
        result1, _, _ = compute_topk_accuracy(
            embeddings[:25], labels[:25], embeddings[25:], labels[25:], [1]
        )
        result2, _, _ = compute_topk_accuracy(
            embeddings[:25], labels[:25], embeddings[25:], labels[25:], [1]
        )
